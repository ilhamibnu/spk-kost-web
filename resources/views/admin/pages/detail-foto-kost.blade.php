...
@section('title', 'Detail Foto Kost')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Data Detail Foto Kost</h4>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table datatables table-hover responsive nowrap" style="width:100%" id="dataTable-1">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            @endphp
                            @foreach($detailfotokost as $data)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td><img src="{{ asset('images/detailkost/'.$data->foto) }}" alt="" class="img-rounded" width="100px"></td>
                                <td>
                            ...
                            <div id="delete{{ $data->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/detail-foto-kost/{{ $data->id }}" method="post">
                                            @csrf
                                            @method('delete')
                            ...
                            <div id="edit{{ $data->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/detail-foto-kost/{{ $data->id }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                            <div class="modal-body">
                ...
                <div id="add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="/detail-foto-kost" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <input hidden name="id_kost" value="{{ $id_kost }}" type="text">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Foto</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
