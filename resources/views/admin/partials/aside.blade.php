    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/kost" aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span class="hide-menu">Kost</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/user" aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span class="hide-menu">User</span></a></li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/penghitungan" aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span class="hide-menu">Penghitungan</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/simulasi-rekomendasi" aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span class="hide-menu">Simulasi Rekomendasi</span></a></li>
            </ul>
        </nav>
