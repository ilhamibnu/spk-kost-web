...
@section('title', 'Register - e-Kostan')

@section('content')


<section id="register" class="bg0 p-t-104 p-b-116">
    <div class="container">
            ...
            <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                ...
                <form action="/register" method="POST">
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent">
                        <input class="stext-111 cl2 plh3 size-116 p-lr-28 p-tb-25" type="text" name="name" placeholder="Your Full Name" required>
                    </div>
